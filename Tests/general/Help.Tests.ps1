...
Param (
	...
	[string[]]
	$CommandPath = @("$global:testroot\..\RTShell\functions", "$global:testroot\..\RTShell\internal\functions"),
...
$CommandPath = @(
    "$global:testroot\..\RTShell\functions"
    "$global:testroot\..\RTShell\internal\functions"
)
